...
<div class="tab-content">
    <div class="tab-pane active" id="common">
        ...
        <!-- <div class="row">
            <div class="col-sm-12 popover-help" data-original-title='<?= $model->getAttributeLabel('desc1'); ?>'
                 data-content='<?= $model->getAttributeDescription('desc1'); ?>'>
                <?= $form->labelEx($model, 'desc1'); ?>
                <?php $this->widget(
                ...
                <?=  $form->error($model, 'desc1'); ?>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-sm-12 popover-help" data-original-title='<?= $model->getAttributeLabel('desc2'); ?>'
                 data-content='<?= $model->getAttributeDescription('desc2'); ?>'>
                <?= $form->labelEx($model, 'desc2'); ?>
                <?php $this->widget(
                    'yupe\widgets\editors\Textarea',
                    [
                        'model'     => $model,
