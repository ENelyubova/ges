...
class Page extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['image, icon, body, body_short, desc1, desc2', 'safe'],
            [
                'lang, id, parent_id, create_time, update_time, title, title_short, slug, body, meta_title, meta_keywords, meta_description, status, order, lang, body_short, desc1, desc2',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'icon' => Yii::t('PageModule.page', 'Дополнительное фото'),
            'body_short' => Yii::t('PageModule.page', 'Короткое описание'),
            'desc1' => Yii::t('PageModule.page', 'Дополнительное описание 1'),
            'desc2' => Yii::t('PageModule.page', 'Дополнительное описание 2'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('desc1', $this->desc1);
        $criteria->compare('desc2', $this->desc2);
