...
/**
   ...
   */
    ...
    /*Проекты*/
    if($('div').hasClass('project-carousel')){
        $('.project-carousel').slick({
            ...
            arrows: true,
            dots: false,
            appendArrows: '.project-block___body .arrows',
            focusOnSelect: false,
    ...
    /*Проект-внутренняя*/
    if($('div').hasClass('project-carousel-page')){
        $('.project-carousel-page').slick({
            fade: false,
            infinite: false,
            slidesToShow: 3,
            slidesToScroll: 1,
            ...
            arrows: true,
            dots: false,
            appendArrows: '.project-wrap .arrows',
            focusOnSelect: false,
            cssEase: 'cubic-bezier(0.7, 0, 0.3, 1)',
            touchThreshold: 100,
            speed: 700, 
