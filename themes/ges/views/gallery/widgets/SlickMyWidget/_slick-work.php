	...
	<a class="" data-fancybox="work" href="<?= $data->image->getImageUrl(); ?>">
		<div class="work-carousel__item">
			...
			<picture class="absolute-img-picture">
	            ...
	            <source media="(min-width: 1px)" srcset="<?= $data->image->getImageUrlWebp(360, 210, true, null,'file'); ?>" type="image/webp">
	            <source media="(min-width: 1px)" srcset="<?= $data->image->getImageNewUrl(360, 210, true, null,'file'); ?>">
