<?php if($pages) : ?>
    <div class="project-design">
        <div class="content-sit design-width"><?= $pages->title_short; ?></div>
    </div>
                                            ...
                                            <?php if ($key >= 0 && $key < 1) : ?>
                                                <div class="project-left-img">
                                                    <picture class="absolute-img-picture">
                                                        ...
                                                        <source media="(min-width: 1px)" srcset="<?= $image->getImageUrlWebp(270, 530, true, null,'image'); ?>" type="image/webp">
                                                        <source media="(min-width: 1px)" srcset="<?= $image->getImageNewUrl(270, 530, true, null,'image'); ?>">
                                            ...
                                            <?php if ($key >= 1 && $key < 2) : ?>
                                                <div class="project-right-img">
                                                    <picture class="absolute-img-picture">
                                                        ...
                                                        <source media="(min-width: 1px)" srcset="<?= $image->getImageUrlWebp(380, 530, true, null,'image'); ?>" type="image/webp">
                                                        <source media="(min-width: 1px)" srcset="<?= $image->getImageNewUrl(380, 530, true, null,'image'); ?>">
